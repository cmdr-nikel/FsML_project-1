...
import numpy as np
import joblib
from Scripts.features.atomar import extract_features_from_article, build_feature_matrix
...
if __name__ == "__main__":
    MODEL_PATH = Path(__file__).parents[2] / "Models" / "linearcvs" / "linearsvc_atom_1117k_4cls.pkl"
